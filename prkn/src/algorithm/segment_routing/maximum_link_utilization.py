...
class MaximumLinkUtilization(GenericSR):
    ...
    def solve(self) -> dict:
      ...
      utilization = {(i, j): self.__flow_sum[i, j] / self.__nx_graph[i][j]["capacity"] for i, j, _ in self.__links}
    ...
    def get_name(self):
        return f"maximum_link_utilization"
